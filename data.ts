...
export const pillarData = {
    ...
    luz: { 
        ...
        content: `
            ...
            <p class="mb-4 text-gray-400">O <strong>Surrealismo</strong>, como movimento artístico, nos deu uma chave. Artistas como <strong>Salvador Dalí</strong> usavam métodos como o paranoico-crítico para acessar e pintar as imagens do subconsciente, transformando sonhos e o irracional em arte. <strong>René Magritte</strong>, por outro lado, nos desafia a questionar a própria realidade com sua "Traição das Imagens", mostrando que o mapa não é o território. Juntos, eles nos dão ferramentas para explorar e decifrar nosso mundo interior.</p>
            <p class="text-sm text-gray-500"><strong>Termos de Pesquisa:</strong> "método paranoico-crítico Salvador Dalí", "René Magritte A Traição das Imagens", "arte surrealista".</p>
...
export const altarData = {
    ...
    seals: [
        { 
            ...
            active: true,
            lema: "Florescer",
            purpose: "Júpiter, o Grande Benéfico, rege a expansão, a benevolência, a sorte, a organização, a sabedoria e o crescimento. Na Cabala, sua energia corresponde à Sefirah Chesed (Misericórdia ou Grandeza), a força que constrói, nutre e expande. Seu ciclo atual, que se estende de 2025 a aproximadamente 2032, é uma janela cósmica para plantar e colher com abundância, organizar sua vida e expandir seus horizontes.",
            pantacles: [
    ...
    'Outono': [
        { 
            ...
            content: {
                ...
                insightsDoBemViver: "A energia da Arruda nos ensina sobre a importância de estabelecer limites energéticos saudáveis. O ato de cuidar da planta fortalece essa conexão."
            }
        },
        { 
            name: 'Guiné', 
...
export const cosmogramData = {
    ...
    sun: {
        ...
        uses: `<ul class="list-disc list-inside space-y-1"><li><strong>Programação:</strong> Segure o quartzo, visualize sua intenção e "sopre" essa intenção para dentro do cristal.</li><li><strong>Grades de Cristal:</strong> Use-o no centro de qualquer grade para amplificar seu poder.</li></ul>`,
